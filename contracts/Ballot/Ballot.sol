...
contract Ballot {
    ...
    // 为 proposalNaems 中的每个提案，创建一个新的（投票）表决
    ...
    function giveRightToVoter(address voter) public {
        require(msg.sender == chairperson, "only chairperson can give right to voter");
    ...
    // 用 winningProposal() 函数以获取提案数组中获胜者的索引，并以此返回获胜者的名称
